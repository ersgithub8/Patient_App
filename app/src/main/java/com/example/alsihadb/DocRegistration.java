    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(DocRegistration.this, "Fill all the fields", Toast.LENGTH_SHORT).show();
                }
                else if(!pass.getText().toString().equals(cpass.getText().toString()))
                {
                    Toast.makeText(DocRegistration.this, "Password not match", Toast.LENGTH_SHORT).show();
                }
                else
                {

                    Intent i=new Intent(DocRegistration.this,DocRegFinal.class);
